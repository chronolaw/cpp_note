...
//
// g++ cli.cpp -std=c++17 -I../common -lzmq -lpthread -o c.out;./c.out
// g++ cli.cpp -std=c++17 -I../common -lzmq -lpthread -g -O0 -o c.out
// g++ cli.cpp -std=c++17 -I../common -lzmq -lpthread -g -O0 -o c.out;./c.out
