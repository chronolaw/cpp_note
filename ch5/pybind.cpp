...
//
// g++ pybind.cpp -std=c++17 -shared -fPIC `python3 -m pybind11 --includes` -o pydemo`python3-config --extension-suffix`
// g++ pybind.cpp -std=c++20 -shared -fPIC `python3 -m pybind11 --includes` -o pydemo`python3-config --extension-suffix`
